...
export const translations = {
  ru: {
    ...
    brands: { title: 'Запчасти для техники этих марок' },
    cart: {
      badge: 'Корзина', title: 'Список запроса',
      subtitle: 'Соберите нужные позиции — мы рассчитаем цену и подтвердим наличие в течение часа.',
      empty: 'Список пуст', emptySub: 'Добавьте детали из каталога, чтобы отправить запрос.',
      summary: 'Итого', positions: 'Позиций', totalQty: 'Всего единиц', pcs: 'шт',
      priceNote: 'Цена не указана на сайте — рассчитываем индивидуально с учётом объёма и наличия.',
      send: 'Отправить запрос', continue: 'Продолжить выбор',
      clear: 'Очистить список', remove: 'Удалить', added: 'Добавлено',
      requestIntro: 'Здравствуйте! Прошу рассчитать цену и наличие по следующим позициям:',
    },
    about: {
    ...
    trust: {
      badge: 'Почему мы', title: 'Создано для тех, кто выбирает качество.',
  ...
  en: {
    ...
    brands: { title: 'Parts for these truck & machinery makes' },
    cart: {
      badge: 'Cart', title: 'Request list',
      subtitle: 'Collect the parts you need — we will quote and confirm availability within an hour.',
      empty: 'Your list is empty', emptySub: 'Add parts from the catalog to send a request.',
      summary: 'Summary', positions: 'Items', totalQty: 'Total units', pcs: 'pcs',
      priceNote: 'Prices are not listed on the site — we quote individually based on volume and stock.',
      send: 'Send request', continue: 'Continue browsing',
      clear: 'Clear list', remove: 'Remove', added: 'Added',
      requestIntro: 'Hello! Please quote price and availability for the following items:',
    },
    about: {
    ...
    trust: {
      badge: 'Why choose us', title: 'Built for those who choose quality.',
  ...
  uz: {
    ...
    brands: { title: 'Ushbu markadagi texnika uchun qismlar' },
    cart: {
      badge: 'Savat', title: 'So‘rov ro‘yxati',
      subtitle: 'Kerakli qismlarni yig‘ing — bir soat ichida narx va mavjudlikni tasdiqlaymiz.',
      empty: 'Ro‘yxat bo‘sh', emptySub: 'So‘rov yuborish uchun katalogdan qism qo‘shing.',
      summary: 'Jami', positions: 'Pozitsiyalar', totalQty: 'Umumiy soni', pcs: 'dona',
      priceNote: 'Narx saytda ko‘rsatilmagan — hajm va mavjudlikka qarab alohida hisoblaymiz.',
      send: 'So‘rov yuborish', continue: 'Tanlashda davom etish',
      clear: 'Ro‘yxatni tozalash', remove: 'O‘chirish', added: 'Qo‘shildi',
      requestIntro: 'Assalomu alaykum! Quyidagi pozitsiyalar bo‘yicha narx va mavjudlikni ayting:',
    },
    about: {
    ...
    trust: {
      badge: 'Nega biz', title: 'Sifatni tanlaydiganlar uchun.',
