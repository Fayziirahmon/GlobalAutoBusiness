  ...
  return (
    <Link to={`/product/${id}`} className="product-card">
      ...
      <div className="product-card__media">
        ...
        {category && <span className="product-card__chip">{catName(category, lang)}</span>}

        {reviews > 0 && (
          <span className="product-card__rating">
            <Icon name="star" size={11} strokeWidth={1.5} /> {rating}
          </span>
        )}

        {/* Hover overlay */}
        <span className="product-card__overlay">
          {t('common.viewDetails')} <Icon name="arrow" size={14} />
        </span>
      </div>
      ...
      <div className="product-card__body">
        ...
        <div className="product-card__foot">
          <div>
            ...
            <div className="product-card__price" style={{ fontSize: price > 0 ? 17 : 12.5 }}>
